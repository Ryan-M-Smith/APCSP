#
# FILENAME: ui.py | APCSP Conversion Project
# DESCRIPTION: Load the TKinter GUI
# CREATED: 2022-11-15 @ 12:13 PM
...
class Window(ThemedTk):
	...
	__dimensions = namedtuple("WinSize", ["width", "height"])

	def __init__(self, title: str = "Window", width: int = 500, height: int = 500, theme: str = None) -> None:
	...
	def dimensions(self) -> __dimensions:
		return self.__dimensions(self.winfo_width(), self.winfo_height())
